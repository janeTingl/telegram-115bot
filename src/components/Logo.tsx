  ...
  return (
    <div className={`flex items-center gap-3 select-none ${collapsed ? 'justify-center' : ''} group`}>
      <div className="relative w-10 h-10 flex items-center justify-center">
        ...
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="relative z-10 w-6 h-6 text-brand-400 group-hover:text-white transition-colors duration-300">
          ...
          <path d="M14 13l3.5-3.5" /><path d="M22 14.5L17.5 9.5" /><path d="M19 19h1" />
        </svg>
      </div>
      {!collapsed && (
        <div className="flex flex-col">
          <h1 className="font-bold text-xl tracking-tight text-white leading-none flex items-center gap-1">115<span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-400 to-indigo-400 font-light">Bot</span></h1>
